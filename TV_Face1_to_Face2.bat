...
:: Копируем FaceID_1 на FaceID_2 без замены настроек (без settings.json)
xcopy /s /e /y /i /exclude:lst.txt  "%localappdata%\Programs\TVision\app\faceid1\*" "%localappdata%\Programs\TVision\app\faceid2\*"
timeout
